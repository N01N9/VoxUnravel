...
def squim_objective_model(
    ...
    """Build a custome :class:`torchaudio.prototype.modules.SquimObjective` model.
...
def squim_objective_base() -> SquimObjective:
    """Build :class:`torchaudio.prototype.modules.SquimObjective` model with default arguments."""
...
class SquimObjectiveBundle:
    ...
    def get_model(self, *, dl_kwargs=None) -> SquimObjective:
        ...
        Returns:
            Variation of :py:class:`~torchaudio.modules.SquimObjective`.
        """
...
SQUIM_OBJECTIVE.__doc__ = """SquimObjective pipeline trained using approach described in
    ...
    The underlying model is constructed by :py:func:`torchaudio.modules.squim_objective_base`.
