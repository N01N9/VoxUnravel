...
class MainWindow(QMainWindow):
    ...
    def _build_main_ui(self):
        ...
        btn_auto_out.clicked.connect(lambda: self.browse_generic(self.auto_output_dir, 'save_dir'))
        ...
        btn_clean_dir.clicked.connect(lambda: self.browse_generic(self.clean_input_dir, 'dir'))
